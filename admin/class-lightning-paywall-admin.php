...
class Lightning_Paywall_Admin
{
	...
	public function general_admin_notice(){
		?>	
		<div style="background-color:#c4e7f8;" class="notice is-dismissible">
			<h3 style="font-size:18px;"><a href="https://wordpress.org/plugins/btcpaywall" target="_blank">Upgrade to BTCPayWall</a></h3>
			<p style="font-size:16px;"><strong>Lightning Paywall</strong> will not be maintained any further. We are working on BTCPayWall, which is an up-to-date version of <strong>Lightning Paywall</strong>.</p>
 		</div>
		<?php
	}
}